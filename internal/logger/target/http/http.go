...
func (h *HTTPTrgt) Write(batch []interface{}) (n int, err error) {
...
func (h *HTTPTrgt) WriteBatch(batch []interface{}) (n int, err error) {
	return 0, err
}

func (h *HTTPTrgt) Send(payload []byte) (n int, err error) {
